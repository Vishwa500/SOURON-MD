        ...
        if (_0x33bcb9 === '1') {
          ...
          if (_0x33bcb9 === '2') {
            await _0xd77fff.sendMessage(_0x41d115, {
              ...
              'caption': "*© ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴠɪꜱʜᴡᴀ ᴋᴏᴅɪᴛʜᴜᴡᴀᴋᴋᴜ*"
            }, {
              'quoted': _0x58803e
            });
          } else if (_0x33bcb9 === '3') {
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'caption': _0x1d0aed.title + " |  *ᴠɪꜱʜᴡᴀ ᴀɴᴅ ꜱᴀᴅᴇᴇᴘᴀ *\n\n> ꜱᴏᴜʀᴏɴ-ᴍᴅ"
                }, {
                  'quoted': _0x171143
                });
              } else {
